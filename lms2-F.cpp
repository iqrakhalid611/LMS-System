 ...
 return false;
  ...
  studentnamelist[h]	='\0';
	...
	{ cout<<" Enter registration Number of the student for course registration: "<< endl;
	  ...
	  cout<< endl;
	  c++;
	  "Course has been registered successfully /n";
		
	}
	void unregisterCourse(string codeList[],string registrationlist[],string regno,string courseCode,int& c)
  ...
  if(loadUsers(userlist,passwordList))
{
  ...
  << "4 view All Course"<< endl<<"5 View All Course Of a smester"<< endl 
   << "6 Add new student"<< endl
  << "7 Update student"<< endl
  << "8 delete student"<< endl
  << "9 view all student"<< endl
  << " 10 Register the course for one student"<< endl
  << "11 UNregister the course for one student"<< endl
     		...
     		deleteCourse( codeList, nameList, creditHours, smesterList,repeat);
     		 ...
     		 case 6:
     	    	...
     	    	updatestudent(studentnamelist,registrationlist,name, regesno,h);
					 ...
					 break;
					 case 11:
					 	unregisterCourse(codeList,registrationlist, regesno, courseCode,c);
					 	break;
     	    	case 12:
